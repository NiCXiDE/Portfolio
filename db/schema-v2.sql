...
-- Applied additively by `npm run db:apply-v2`.
-- Does NOT alter legacy tables except additive column `testimonials.entity_id`.
...
-- ---------------------------------------------------------------------------
-- migration_map (idempotency + traceability; one row per migrated target)
-- ---------------------------------------------------------------------------
