...
const es = {
  ...
  nav: {
    ...
    backToGraphic: "Volver a Diseño Gráfico",
    backToInterfaces: "Volver a Interfaces",
    lang: "EN",
  ...
  interfaces: {
    ...
    catAppsMobile: "Apps / Mobile",
    mixedPlatformBadge: "Web + Mobile",
    mixedTotemBadge: "Web + Totem",
    ...
    orphanListHeading: "Más proyectos",
    placeholderVisual: "Visual próximamente",
  },
  grafico: {
    ...
    logoResources: "Recursos gráficos",
    emptyLogoResources: "Pronto más recursos de este logotipo.",
    emptyEventResources: "Pronto más recursos de este evento.",
...
const en: typeof es = {
  ...
  nav: {
    ...
    backToGraphic: "Back to Graphic Design",
  ...
  interfaces: {
    ...
    orphanListHeading: "More projects",
    placeholderVisual: "Visual coming soon",
  },
  grafico: {
    ...
    logoResources: "Graphic assets",
    emptyLogoResources: "More assets for this logo coming soon.",
    emptyEventResources: "More assets for this event coming soon.",
